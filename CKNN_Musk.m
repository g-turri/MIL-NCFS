...
refs= 2;
citers= refs+2;
str = strcat('CKNN_R',num2str(refs),'_C',num2str(citers),'_Musk1');
...
%             BagTEnorm = mat2cell(Xte2,tempvec2, dim);
        ...
        [predictNCA{fold}] = CKNNw(BagPosTR,BagNegTR,BagTE,refs,citers,tie,wsquared,metric);
        [predict{fold}] = CKNNw(BagPosTR,BagNegTR,BagTE,refs,citers,tie,ones(dim,1),metric);
